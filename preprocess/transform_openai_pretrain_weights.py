...
def parse_args():
    ...
    parser.add_argument("--raw-ckpt-path", type=str, default='D:/ViT-B-16.pt', help="specify the path of the original openai checkpoint")
    parser.add_argument("--new-ckpt-path", type=str, default='../training/pretrain_model/ViT-B-16.state_dict.pt', help="specify the path of the transformed checkpoint")
